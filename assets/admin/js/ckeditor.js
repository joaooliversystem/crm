...
(function () {
    ...
    CKEDITOR.env || (CKEDITOR.env = function () {
        ...
        if (a.gecko) if (g <
            10900) a.cssClass = a.cssClass + " cke_browser_gecko18"; else if (g <= 11E3) a.cssClass = a.cssClass + " cke_browser_gecko19";
    ...
    (function () {
        ...
        CKEDITOR.tools = {
            arrayCompare: function (a, b) {
                ...
                var b = a.$,
                    e = a.base, d = a.privates || a._, c = a.proto, a = a.statics;
                !b && (b = function () {
                    e && this.base.apply(this, arguments)
                });
                if (d) var i = b, b = function () {
                ...
                return function () {
                    ...
                    window.setTimeout(function () {
                        a.apply(e, b)
                                           ...
                                           b) {
                var e = [], d, c = CKEDITOR.tools.parseCssText(a, true, b);
    ...
    CKEDITOR.dtd = function () {
        var b = CKEDITOR.tools.extend, c = function (a, b) {
                ...
                table: 1,
                ul: 1
            }, d = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, f = {}, i = {"#": 1},
        ...
        b(c, {
            $block: b({audio: 1, dd: 1, dt: 1, li: 1, video: 1}, e, j),
            $blockLimit: {
                article: 1,
                aside: 1,
                audio: 1,
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        appendTo: function (b, c) {
            ...
            var a = this.$.cloneNode(b), g = function (a) {
            ...
            for (var c = [], a = this.getDocument().$.documentElement, g = this.$; g && g != a;) {
                var e = g.parentNode;
                e && c.unshift(this.getIndex.call({$: g}, b));
                g = e
            }
            return c
            ...
            if (a && !a.call) var g = a, a = function (a) {
                return !a.equals(g)
            };
    ...
    CKEDITOR.dom.element.clearMarkers = function (b, c, a) {
        var g = c.getCustomData("list_marker_names"), e = c.getCustomData("list_marker_id"), d;
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            hasAttributes: CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) ? function () {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], f = 0; f < c.length; f++) if (d) for (var i = 0; i < d.length; i++) b.push([a, c[f], d[i]].join("-")); else b.push([a, c[f]].join("-"));
                ...
                var b = 0, c = 0, d = this.getDocument(), f = d.getBody(), i = d.$.compatMode == "BackCompat";
                if (document.documentElement.getBoundingClientRect) {
                    var j =
                            this.$.getBoundingClientRect(), l = d.$.documentElement, n = l.clientTop || f.$.clientTop || 0,
                        m = l.clientLeft || f.$.clientLeft || 0, o = true;
                    if (CKEDITOR.env.ie) {
                ...
                function l(b, m) {
                    if (/body|html/.test(a.getName())) a.getWindow().$.scrollBy(b, m); else {
                ...
                i = a.getWindow();
                f = n(this, i);
                var k = n(a, i), h = this.$.offsetHeight;
                d = this.$.offsetWidth;
                var s = a.$.clientHeight, w = a.$.clientWidth;
            ...
            copyAttributes: function (a, b) {
                for (var c = this.$.attributes, b = b || {}, d = 0; d < c.length; d++) {
                    var f = c[d], i = f.nodeName.toLowerCase(), j;
                    if (!(i in b)) if (i == "checked" && (j = this.getAttribute(i))) a.setAttribute(i, j); else if (f.specified || CKEDITOR.env.ie && f.nodeValue && i == "value") {
    ...
    (function () {
        function b(a, b) {
            ...
            d = c.endContainer;
            var m = c.startOffset, o = c.endOffset, k, h = this.guard, s = this.type,
            ...
            if (this.current) d = this.current[g](false, s, k); else {
                if (a) d.type ==
                CKEDITOR.NODE_ELEMENT && (d = o > 0 ? d.getChild(o - 1) : k(d, true) === false ? null : d.getPreviousSourceNode(true, s, k)); else {
                    d = n;
    ...
    (function () {
        ...
        var g = function (a) {
                ...
                a.optimizeBookmark();
                var h = a.startContainer, d = a.endContainer, g = a.startOffset, e = a.endOffset, f, i;
                ...
                if (h.type == CKEDITOR.NODE_TEXT) {
                    ...
                    f = true
                } else h = h.getChild(g).getPrevious(); else {
                    h = h.append(a.document.createText(""), 1);
                    f = true
                }
                var g = h.getParents(), e = d.getParents(), j, q, p;
                ...
                for (var l = c, r, C, y, u = j; u < g.length; u++) {
                    ...
                    for (r = r.getNext(); r;) {
                        ...
                        y = r.getNext();
                        if (b == 2) l.append(r.clone(true)); else {
                            r.remove();
                            b == 1 && l.append(r)
                        }
                        r = y
                ...
                for (c = j; c < e.length; c++) {
                    ...
                    if (!g[c] || r.$.parentNode != g[c].$.parentNode) for (r = r.getPrevious(); r;) {
                        ...
                        y = r.getPrevious();
                        if (b == 2) l.$.insertBefore(r.$.cloneNode(true), l.$.firstChild); else {
                            r.remove();
                ...
                u: 1,
                "var": 1
            }, f = CKEDITOR.dom.walker.bogus(), i = new CKEDITOR.dom.walker.whitespaces,
            j = new CKEDITOR.dom.walker.bookmark, l = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/;
        CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                var b = this.startContainer, c = this.endContainer, d = this.startOffset, h = this.endOffset,
                    g = this.collapsed, e, f;
                ...
                var a = this.startContainer, b = this.endContainer, c = this.startOffset, d = this.endOffset, h;
                ...
                if (b.type == CKEDITOR.NODE_ELEMENT) {
                    h = b.getChildCount();
                    if (h > d) b = b.getChild(d).getPreviousSourceNode(true); else if (h < 1) b = b.getPreviousSourceNode();
                    else {
                ...
                var c = this.startContainer,
                    d = this.startOffset, h = this.collapsed;
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        var d = this.getCommonAncestor(), h = this.root, g, e, f, i, j, l = false, q, p;
                            ...
                            for (; i;) {
                                ...
                                if (i.type == CKEDITOR.NODE_COMMENT) i = i.getPrevious(); else {
                                    if (i.type == CKEDITOR.NODE_TEXT) {
                                        ...
                                        p =
                                            i.getText();
                                        if (/[^\s\ufeff]/.test(p)) i = null; else for (var A = i.$.getElementsByTagName("*"), r = 0, C; C = A[r++];) if (!CKEDITOR.dtd.$removeEmpty[C.nodeName.toLowerCase()]) {
                                            i = null;
                                            break
                                        }
                                        i && (q = !!p.length)
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            f = this.clone();
                            f = new CKEDITOR.dom.walker(f);
                            var G = CKEDITOR.dom.walker.whitespaces(), E = CKEDITOR.dom.walker.bookmark();
                ...
                if (!this.collapsed) {
                    var a = a || CKEDITOR.SHRINK_TEXT, d = this.clone(), h = this.startContainer, f = this.endContainer,
                        g = this.startOffset, e = this.endOffset, i = 1, j = 1;
                    if (h && h.type == CKEDITOR.NODE_TEXT) if (g) if (g >= h.getLength()) d.setStartAfter(h); else {
                        d.setStartBefore(h);
                        i = 0
                    } else d.setStartBefore(h);
                    if (f && f.type == CKEDITOR.NODE_TEXT) if (e) if (e >= f.getLength()) d.setEndAfter(f); else {
                        d.setEndAfter(f);
                        j = 0
            ...
            moveToPosition: function (a, b) {
                ...
                var b =
                    ...
                    c = new CKEDITOR.dom.elementPath(this.endContainer, this.root), d = b.block, h = c.block, f = null;
                ...
                return {previousBlock: d, nextBlock: h, wasStartOfBlock: a, wasEndOfBlock: b, elementPath: f}
        ...
        b.prototype = {
            getNextParagraph: function (b) {
                ...
                for (this._.nextNode = null; k;) {
                    var h = 0, s = k.hasAscendant("pre"), w = k.type != CKEDITOR.NODE_ELEMENT, v = 0;
                    if (w) k.type == CKEDITOR.NODE_TEXT && a.test(k.getText()) && (w = 0); else {
                        var t = k.getName();
                        if (k.isBlockBoundary(this.forceBrBreak && !s && {br: 1})) {
                            if (t == "br") w = 1; else if (!j && !k.getChildCount() && t != "hr") {
                                e = k;
                                l = k.equals(n);
                                break
                            }
                ...
                if (!e) {
                    ...
                    h = {div: 1, th: 1, td: 1};
                    e = e.block;
                    if (!e && k && !this.enforceRealBlocks && h[k.getName()] && j.checkStartOfBlock() && j.checkEndOfBlock() && !k.equals(j.root)) e = k; else if (!e || this.enforceRealBlocks && e.getName() == "li") {
    ...
    (function () {
        function b(a, b, d, h, f) {
            ...
            if ((h || typeof a.elements != "function" || a.elements(m)) && (!a.match || a.match(b))) {
                if (h = !f) {
                    a:if (a.nothingRequired) h = true; else {
        ...
        function g(a) {
            ...
            return a._.filterFunction = function (h, f, m, e, g, o, k) {
                ...
                if (f) {
                    var i = h.name, m = f.elements[i], v = f.generic, f = {
                    ...
                    m = f.validClasses;
                    u = h.attributes;
                    var v = h.styles, q = u["class"], p = u.style, x, z, t = [], r = [], y = /^data-cke-/, A = false;
                    delete u.style;
                    delete u["class"];
                    if (!f.allAttributes) for (x in u) if (!o[x]) if (y.test(x)) {
                        if (x != (z = x.replace(/^data-cke-saved-/, "")) &&
                            !o[z]) {
                            delete u[x];
                            A = true
                        }
                    ...
                    if (f.allClasses) q && (u["class"] = q); else {
        ...
        function f(a) {
            for (var b, c, d, h, f = {}, m = 1, a = p(a); b = a.match(y);) {
                ...
                f["$" + m++] = {elements: b[1], classes: c, styles: d, attributes: h};
        ...
        function h(a, b, c) {
            var d = a.name;
            if (z.$empty[d] || !a.children.length) if (d == "hr" && b == "br") a.replaceWith(o()); else {
                    ...
                    for (var f = h.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || h.name == "body", g, m = d.length; m > 0;) {
                        ...
                        if (f && (e.type == CKEDITOR.NODE_TEXT || e.type == CKEDITOR.NODE_ELEMENT && z.$inline[e.name])) {
                            ...
                            h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && (e.type ==
                                CKEDITOR.NODE_ELEMENT && !z[h.name][e.name]) && c.push({check: "el-up", el: e})
                        }
                    }
                    a.remove()
                }
        ...
        function w(a, b) {
            var c = b.getDefinition(), d = c.attributes, h = c.styles, f, m, e, g;
        ...
        var z = CKEDITOR.dtd, q = CKEDITOR.tools.copy, p = CKEDITOR.tools.trim, A = "cke-test";
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                this._.cachedChecks = {};
                var h, e;
                if (typeof b == "string") b = f(b); else if (b instanceof
                    CKEDITOR.style) {
                    e = b.getDefinition();
                    d = {};
                    b = e.attributes;
                ...
                for (g in b) {
                    e = b[g];
                    e = typeof e == "boolean" ? {} : typeof e == "function" ? {match: e} :
                        q(e);
                    ...
                    for (s in r) {
                        o[s] = a(o[s], k) || null;
                        var i = o, u = C[s], w = a(o[C[s]], k), j = o[s], v = [], l = true, x = void 0;
                        w ? l = false : w = {};
                ...
                for (o = d.length; e < o; ++e) {
                    ...
                    if (k.elements === true || k.elements === null) {
                        ...
                        i = k.elements;
                        delete k.elements;
                        for (h in i) if (g[h]) g[h][s ? "unshift" : "push"](k); else g[h] = [k]
                    }
                }
                c.elements = g;
                ...
                var d = [], f = !c && this._.rules, m = this._.transformations, e = g(this),
                    o = this.editor && this.editor.config.protectedSource, k = false;
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) e(a, f, m, d, b) && (k = true); else if (a.type == CKEDITOR.NODE_COMMENT && a.value.match(/^\{cke_protected\}(?!\{C\})/)) {
                        var c;
                        a:{
            ...
            addTransformations: function (a) {
                ...
                if (!this.disabled && a) {
                    ...
                    for (h = 0; h < a.length; ++h) {
                        b = a[h];
                        var f = void 0, m = void 0, e = void 0, g = void 0, o = void 0, k = void 0;
                        c = [];
                        for (m = 0; m < b.length; ++m) {
                            ...
                            c.push({
                                check: g == f ? null : g, left: o, right: typeof k == "string" ?
                                    F(k) : k
                            })
                        }
                        b = f;
                ...
                var o = CKEDITOR.tools.clone(e), k = [], i;
                if (b !== false && (i = this._.transformations[e.name])) {
                    for (h = 0; h < i.length; ++h) s(this, e, i[h]);
                    l(e)
                }
                g(this)(o, this._.rules, b === false ? false : this._.transformations, k, false, !c,
                    !c);
        ...
        var r = {styles: 1, attributes: 1, classes: 1},
            C = {styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses"},
            y = /^([a-z0-9*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i,
            u = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/},
            x = CKEDITOR.filter.transformationsTools = {
                sizeToStyle: function (a) {
                    ...
                    if (typeof b == "string") a.name = b; else {
                        var c = b.getDefinition(), d = c.styles, h = c.attributes, e, f, m, g;
                        a.name = c.element;
                        for (e in h) if (e == "class") {
                            c = a.classes.join("|");
                            for (m = h[e].split(/\s+/); g = m.pop();) c.indexOf(g) ==
                            -1 && a.classes.push(g)
    ...
    (function () {
        var b, c = function (a) {
            var a = a.data, c = a.getKeystroke(), d = this.keystrokes[c], f = this._.editor;
            b = f.fire("key", {keyCode: c}) === false;
            if (!b) {
                d && (b = f.execCommand(d, {from: "keystrokeHandler"}) !== false);
        ...
        CKEDITOR.lang = {
            languages: {
                ...
                var a = this.languages, c = c || navigator.userLanguage || navigator.language || b,
                    g = c.toLowerCase().match(/([a-z]+)(?:-([a-z]+))?/), e = g[1], g = g[2];
    ...
    CKEDITOR.scriptLoader = function () {
        ...
        return {
            load: function (a, g, e, d) {
                ...
                f && (a = [a]);
                e || (e = CKEDITOR);
                var i = a.length, j = [], l = [], n = function (a) {
                    ...
                    var m = function (a, b) {
                        ...
                        if (b[a]) m(a, true); else {
                            ...
                            if (!(d.length >
                                ...
                                h.setAttributes({type: "text/javascript", src: a});
    ...
    CKEDITOR.resourceManager.prototype = {
        add: function (b, c) {
            ...
            for (var b = b.split(","), g = 0; g < b.length; g++) this.externals[b[g]] = {dir: c, file: a}
        }, load: function (b, c, a) {
        ...
        return function (a, g, e) {
            var d = {}, f = function (a) {
                b.call(this, a, function (a) {
                    ...
                    if (b.length) f.call(this, b); else {
                        for (i in d) {
                            m = d[i];
                            if (m.onLoad &&
                                !m.onLoad._called) {
    ...
    CKEDITOR.ui.prototype = {
        add: function (b, c, a) {
            ...
            var c = this.items[b], a = c && this._.handlers[c.type],
                g = c && c.command && this.editor.getCommand(c.command), a = a && a.create.apply(this, c.args);
            this.instances[b] = a;
            g && g.uiItems.push(a);
    ...
    (function () {
        ...
        function n(a) {
            ...
            if (d) var f =
                    RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"), c = c.replace(f, ""),
                c = c + ("," + d);
            if (e) var m = RegExp("(?:^|,)(?:" + e.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"), c = c.replace(m, "");
            CKEDITOR.env.air && (c = c + ",adobeair");
            CKEDITOR.plugins.load(c.split(","), function (c) {
                var d = [], e = [], f = [];
                a.plugins = c;
                for (var o in c) {
                    var g = c[o], k = g.lang, i = null, j = g.requires, w;
                    ...
                    if (k && !a.lang[o]) {
                        k.split && (k = k.split(","));
                        if (CKEDITOR.tools.indexOf(k, a.langCode) >= 0) i = a.langCode; else {
                            i = a.langCode.replace(/-.*/, "");
                            i = i != a.langCode && CKEDITOR.tools.indexOf(k, i) >= 0 ? i : CKEDITOR.tools.indexOf(k, "en") >= 0 ? "en" : k[0]
                        }
                        if (!g.langEntries || !g.langEntries[i]) f.push(CKEDITOR.getUrl(g.path + "lang/" + i + ".js")); else {
        ...
        CKEDITOR.htmlParser.prototype = {
            onTagOpen: function () {
                ...
                for (var g, e, d = 0, f; g = this._.htmlPartsRegex.exec(a);) {
                    ...
                    if (e > d) {
                        d = a.substring(d, e);
                        if (f) f.push(d); else this.onText(d)
                    }
                    d =
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.node.prototype = {
            remove: function () {
                var b = this.parent.children, c = CKEDITOR.tools.indexOf(b, this), a = this.previous, g = this.next;
                a && (a.next = g);
                g && (g.previous = a);
                b.splice(c, 1);
                this.parent = null
            }, replaceWith: function (b) {
                var c = this.parent.children, a = CKEDITOR.tools.indexOf(c, this), g = b.previous = this.previous,
                    e = b.next = this.next;
                g && (g.next = b);
                e && (e.previous = b);
                c[a] = b;
                ...
                var c = b.parent.children,
                    a = CKEDITOR.tools.indexOf(c, b), g = b.next;
                c.splice(a + 1, 0, this);
                this.next = b.next;
                this.previous = b;
                b.next = this;
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function (e, d, f) {
            function i(a) {
                ...
                if (s.length > 0) for (var c = 0; c < s.length; c++) {
                    var d = s[c], e = d.name, f = CKEDITOR.dtd[e], m = v.name &&
                        CKEDITOR.dtd[v.name];
                ...
                if (b(e)) s.push(e); else {
                    ...
                    if (d == "br") w.push(e); else {
                        for (; ;) {
                            ...
                            if (!e.isUnknown && !v.isUnknown && !m[d]) if (v.isOptionalClose) k.onTagClose(f); else if (d in a && f in a) {
                                f = v.children;
                                (f = f[f.length - 1]) && f.name == "li" || n(f = new CKEDITOR.htmlParser.element("li"), v);
                                !e.returnPoint && (e.returnPoint = v);
                                v = f
                            } else if (d in CKEDITOR.dtd.$listItem && !o(d, f)) k.onTagOpen(d == "li" ? "ul" : "dl", {}, 0, 1); else if (f in c && !o(d, f)) {
                                !e.returnPoint &&
                                (e.returnPoint = v);
                                v = v.parent
                            } else {
                                f in CKEDITOR.dtd.$inline && s.unshift(v);
                                if (v.parent) n(v, v.parent, 1); else {
                                    e.isOrphan = 1;
                                    break
                                }
                            } else break
            ...
            k.onText = function (b) {
                ...
                var d = v.name, e = d ? CKEDITOR.dtd[d] || (v._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : g;
                if (!t && !e["#"] && d in c) {
    ...
    (function () {
        function b(b, c) {
                ...
                return function (e) {
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if (f) for (o(f, 1) && h.push(f); f;) {
                            if (d(f) && (k = g(f)) && o(k)) if ((i = g(k)) && !d(i)) h.push(k); else {
                                var s = k, w = m(u), D = s.parent.children, l = CKEDITOR.tools.indexOf(D, s);
                                D.splice(l + 1, 0, w);
                                D = s.next;
                                s.next = w;
                                w.previous = s;
                        ...
                        if (h = CKEDITOR.env.opera && !b || (typeof c == "function" ? c(e) !== false : c)) if (!u && CKEDITOR.env.ie && e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) h = false; else if (!u && CKEDITOR.env.ie && (document.documentMode > 7 || e.name in CKEDITOR.dtd.tr || e.name in CKEDITOR.dtd.$listItem)) h = false; else {
                            h = a(e);
            ...
            var k = {elements: {}}, u = c == "html", s = CKEDITOR.tools.extend({}, A), w;
        ...
        function t(a, b) {
            for (var c = [], d = b.config.protectedSource, e = b._.dataStore || (b._.dataStore = {id: 1}), m = /<\!--\{cke_temp(comment)?\}(\d*?)--\>/g, d = [/<script[\s\S]*?<\/script>/gi,
        ...
        CKEDITOR.htmlDataProcessor = function (a) {
            ...
            a.on("toHtml", function (b) {
                    var b = b.data, d = b.dataValue, d = t(d, a), d = o(d), d = k(d), d = d.replace(E, "$1cke:$2"),
                        d = d.replace(L, "<cke:$1$2></cke:$1>"),
                        d = CKEDITOR.env.opera ? d : d.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"),
                        e = b.context || a.editable().getName(), m;
            ...
            a.on("toDataFormat", function (a) {
                ...
                null, null, 10);
            a.on("toDataFormat", function (b) {
                var c = b.data.dataValue, d = m.writer;
                d.reset();
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function (a, b, c, d) {
                ...
                return e.fire("toHtml", {dataValue: a, context: b, fixForBody: c, dontFilter: !!d}).dataValue
            }, toDataFormat: function (a) {
                return this.editor.fire("toDataFormat", {dataValue: a}).dataValue
            }
        };
        var F = /(?:&nbsp;|\xa0)$/,
            z = "{cke_protected}", q = CKEDITOR.dtd, p = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"],
            A = CKEDITOR.tools.extend({}, q.$blockLimit, q.$block),
            r = {elements: {}, attributeNames: [[/^on/, "data-cke-pa-on"]]}, C = {
                ...
                elements: {
                    $: function (a) {
                        ...
                        if (!a.children.length &&
                            !a.attributes.name && !a.attributes["data-cke-saved-name"]) return false
                    }, span: function (a) {
        ...
        var u = /<(a|area|img|input|source)\b([^>]*)>/gi,
            ...
            Q = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, L = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
    "use strict";
    ...
    (function () {
        ...
        function a(a) {
            var b = a.name, c = a.element, g = a.elementMode, l = a.fire("uiSpace", {space: "top", html: ""}).html,
    ...
    (function () {
        function b(b) {
            var c = b.editor, d = c.editable(), e = b.data.path, g = e.blockLimit, f = b.data.selection.getRanges()[0],
                i = c.config.enterMode;
            if (CKEDITOR.env.gecko) {
                var j = e.block || e.blockLimit || e.root, l = j && j.getLast(a);
        ...
        function e(b) {
            var c, d = b.getRanges()[0], b = b.root, e = d.startPath(), g = {table: 1, ul: 1, ol: 1, dl: 1},
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            $: function (a, b) {
                ...
                focus: function () {
                    ...
                    if (!b) {
                        var g = /\n{2}/g;
                        if (g.test(a)) var f = "<" + c + ">", i = "</" + c + ">", a = f + a.replace(g, function () {
                            return i + f
                        }) + i
                    }
                    a = a.replace(/\n/g, "<br>");
                    ...
                    for (var c = this.editor, e = c.config.enterMode,
                        ...
                        if (!l.checkReadOnly()) {
                            ...
                            n = !q && b || b.clone(1);
                            var p, A;
                            if (j) for (; (p = l.getCommonAncestor(0, 1)) && (A = CKEDITOR.dtd[p.getName()]) && (!A || !A[i]);) if (p.getName() in CKEDITOR.dtd.span) l.splitElement(p); else if (l.checkStartOfBlock() && l.checkEndOfBlock()) {
                                l.setStartBefore(p);
                                l.collapse(true);
                                p.remove()
                    ...
                    if (z) {
                        ...
                        if (j) if ((b = z.getNext(a)) && b.type == CKEDITOR.NODE_ELEMENT && b.is(CKEDITOR.dtd.$block)) b.getDtd()["#"] ? l.moveToElementEditStart(b) : l.moveToElementEditEnd(z); else if (!b && e != CKEDITOR.ENTER_BR) {
                ...
                getData: function (a) {
                    ...
                    if (!this.is("textarea")) {
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in {8: 1, 46: 1}) {
                                var h = a.getSelection(), b = h.getRanges()[0], g = b.startPath(), f, k, o, c = c == 8;
                                if (h = e(h)) {
                                    a.fire("saveSnapshot");
        ...
        var i = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi,
            j = CKEDITOR.dom.walker.whitespaces(true), l = CKEDITOR.dom.walker.bookmark(false, true);
        ...
        var n = function () {
            ...
            function d(a, c) {
                var e = [], g = a.getChildren(), h = g.count(),
                    f, o = 0, i = j[c], l = !a.is(j.$inline) || a.is("br");
                for (l && e.push(" "); o < h; o++) {
                    f = g.getItem(o);
            ...
            var j = CKEDITOR.dtd, l = {
                ...
                dl: 1,
                blockquote: 1
            }, n = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, z = CKEDITOR.tools.extend({}, j.$inline);
            delete z.br;
            return function (l, p, t) {
                var r = l.editor;
                l.getDocument();
                var C = r.getSelection().getRanges()[0], y = false;
                if (p == "unfiltered_html") {
                    p = "html";
                    y = true
                }
                if (!C.checkReadOnly()) {
                    var u = (new CKEDITOR.dom.elementPath(C.startContainer, C.root)).blockLimit || C.root, p = {
                        type: p,
                        dontFilter: y,
                        editable: l,
                        editor: r,
                        ...
                        mergeCandidates: [],
                        zombies: []
                    }, r = p.range, y = p.mergeCandidates, x, I, G, E;
                    ...
                    if (!r.collapsed) {
                        var u = G.block || G.blockLimit, Q = r.getCommonAncestor();
                        u && (!u.equals(Q) && !u.contains(Q) && r.checkEndOfBlock()) && p.zombies.push(u);
                        r.deleteContents()
                    }
                    for (; (E = b(r.startContainer) && r.startContainer.getChild(r.startOffset - 1)) && b(E) && E.isBlockBoundary() && I.contains(E);) r.moveToPosition(E, CKEDITOR.POSITION_BEFORE_END);
                    ...
                    for (u = x.startNode; (u = u.getParent()) && e(u);) y.push(u);
                    r.moveToBookmark(x);
                    if (t) {
                        E = t;
                        t = p.range;
                        ...
                        p.dataWrapper = x;
                        D = p.range;
                        var L = D.document, B, t = p.blockLimit;
                        x = 0;
                        var J;
                        E = [];
                        var H, N, y = r = 0, K, O;
                        I = D.startContainer;
                        var u = p.endPath.elements[0], P;
                        G = u.getPosition(I);
                            ...
                            if (B = G.isLineBreak) {
                                ...
                                if (G.hasBlockSibling) B =
                                    ...
                                    if (!M || !M.is({div: 1, p: 1})) B = 0; else {
                                        R = M.getPosition(K);
                                        if (R == CKEDITOR.POSITION_IDENTICAL || R == CKEDITOR.POSITION_CONTAINS) B = 0; else {
                                            K = B.splitElement(M);
    ...
    (function () {
        ...
        function g(a) {
            ...
            var c = a.startContainer, d = a.getPreviousNode(j, null, c), e = a.getNextNode(j, null, c);
        ...
        function d(a, b) {
            ...
            if (c) {
                if (b !== false) {
                    var d, e = a.getDocument().getSelection().getNative(), g = e && e.type != "None" &&
                        e.getRangeAt(0);
        ...
        CKEDITOR.on("instanceCreated", function (a) {
            ...
            var g = a.editor;
            g.define("selectionChange", {errorProof: 1});
            g.on("contentDom", function () {
                var a = g.document, e = CKEDITOR.document, f = g.editable(), o = a.getBody(),
                    m = a.getDocumentElement(), i = f.isInline(), j;
            ...
            getNative: function () {
                ...
                var a = l ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var g = d.children, f, i, m = b.duplicate(), k = 0, j = g.length - 1, l = -1, n, y; k <= j;) {
                            ...
                            if (n > 0) j = l - 1; else if (n < 0) k = l + 1; else {
                        ...
                        e = m.text.replace(/(\r\n|\r)/g, "\n").length;
                        if (!e) return {container: d, offset: a(f) + (n > 0 ? 0 : 1)};
                        for (; e > 0;) try {
                        ...
                        return {container: y, offset: n > 0 ? -e : y.nodeValue.length + e}
                    };
                    return function () {
                ...
                return function (b) {
                    ...
                    if (b) for (var d =
                        ...
                        if (!g.collapsed) {
                            ...
                            b = g.startContainer;
                            f = g.endContainer;
                            var i = g.startOffset, j = g.endOffset, l = g.clone();
                ...
                if (a.length) if (this.isLocked) {
                    ...
                    if (l) {
                        ...
                        var b = a[0], a = b.collapsed, i, j, t, F = b.getEnclosedNode();
        ...
        if (!a) {
            ...
            this.on("selectionChange", function (b) {
                for (var c = 0; c < a.length; c++) {
                    var d = a[c], f = d.style.checkActive(b.data.path) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF;
                    d.fn.call(this, f)
                }
            })
        }
    ...
    (function () {
        ...
        function c(a) {
            ...
            if (a.collapsed) {
                ...
                var d = this.element, e = this._.definition, g, f = e.ignoreReadonly, h = f || e.includeReadonly;
                h == void 0 && (h = a.root.getCustomData("cke_includeReadonly"));
                var i = CKEDITOR.dtd[d] ||
                    (g = true, CKEDITOR.dtd.span);
                a.enlarge(CKEDITOR.ENLARGE_INLINE, 1);
                a.trim();
                var j = a.createBookmark(), l = j.startNode, m = j.endNode, k = l, n;
                if (!f) {
                    var p = a.getCommonAncestor(), f = b(l, p), p = b(m, p);
                ...
                for (k.getPosition(m) == CKEDITOR.POSITION_FOLLOWING && (k = 0); k;) {
                    ...
                    if (k.equals(m)) {
                        ...
                        var q = k.type, r = q == CKEDITOR.NODE_ELEMENT ? k.getName() : null,
                        ...
                        if (!r || i[r] && !t && (!p || h) && (k.getPosition(m) | CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule || e.childRule(k))) {
                            ...
                            if (v && ((v.getDtd() || CKEDITOR.dtd.span)[d] || g) && (!e.parentRule || e.parentRule(v))) {
                                ...
                                if (q == CKEDITOR.NODE_TEXT || p || q == CKEDITOR.NODE_ELEMENT && !k.getChildCount()) {
                                    for (var q = k, w; (f = !q.getNext(C)) && (w = q.getParent(), i[w.getName()]) && (w.getPosition(l) | CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_FOLLOWING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule ||
                                        e.childRule(w));) q = w;
                                    n.setEndAfter(q)
                                }
                            } else f = true
        ...
        var q = {
                ...
                audio: 1,
                video: 1
            }, A = /\s*(?:;\s*|$)/, r = /#\((.+?)\)/g, C = CKEDITOR.dom.walker.bookmark(0, 1),
    ...
    (function () {
        ...
        CKEDITOR.dom.elementPath = function (c, e) {
            var d = null, f = null, i = [], e = e || c.getDocument().getBody(), j = c;
    ...
    CKEDITOR.dom.elementPath.prototype = {
        compare: function (b) {
            ...
            } : typeof b == "function" ? g = b : typeof b == "object" && (g =
                function (a) {
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
        type: CKEDITOR.NODE_TEXT, getLength: function () {
            ...
            var c = this.$.parentNode, a = c.childNodes.length, g = this.getLength(), e = this.getDocument(),
    ...
    (function () {
        function b(a, b, c) {
            var d = a.serializable, f = b[c ? "endContainer" : "startContainer"], i = c ? "endOffset" : "startOffset",
                        ...
                        if (i && a.length > 1) {
                            ...
                            if (f) for (var l = 0; a[d + l + 1];) {
                                ...
                                1].startNode); ;) {
                                    ...
                                    if (n.equals(j)) f = 1; else if (b(j) || j.type == CKEDITOR.NODE_ELEMENT && j.isBlockBoundary()) continue;
                                    break
                                }
                                if (!f) break;
                                l++
    ...
    (function () {
        ...
        var f = "cke_ui_color", i = [], j = /\$color/g;
        CKEDITOR.on("instanceLoaded", function (a) {
            if (!CKEDITOR.env.ie || !CKEDITOR.env.quirks) {
                var b = a.editor, a = function (a) {
                    ...
                    if (!a.getById("cke_ui_color")) {
                        ...
                        i.push(a);
                        var c = b.getUiColor();
                        c && e([a], CKEDITOR.skin.chameleon(b, "panel"), [[j, c]])
                    }
                };
                b.on("panelShow", a);
                b.on("menuShow", a);
    ...
    (function () {
        function v(a) {
            ...
            function j(d, b) {
                ...
                if (!c.getById("cke_pastebin")) {
                    var f = a.getSelection(), h = f.createBookmarks(), i = new CKEDITOR.dom.element(e.is("body") &&
                    !CKEDITOR.env.ie && !CKEDITOR.env.opera ? "body" : "div", c);
            ...
            function u(d) {
                var b =
                    {type: "auto"}, c = a.fire("beforePaste", b);
                j(d, function (a) {
        ...
        function y() {
            var a = new CKEDITOR.htmlParser.filter, b = {
                    ...
                    table: 1,
                    ul: 1
                }, e = CKEDITOR.tools.extend({br: 0}, CKEDITOR.dtd.$inline), c = {p: 1, br: 1, "cke:br": 1},
            ...
            a.addRules({
                elements: {
                    h1: g, h2: g, h3: g, h4: g, h5: g, h6: g, img: function (a) {
                        ...
                        if ("br" == j) return a;
                        if (b[j]) a.name =
                            "p"; else if (e[j]) delete a.name; else if (f[j]) {
    ...
    (function () {
        ...
        CKEDITOR.plugins.add("justify", {
            init: function (a) {
                if (!a.blockless) {
                    var c = new f(a, "justifyleft", "left"), b = new f(a, "justifycenter", "center"), h = new f(a,
                        "justifyright", "right"), d = new f(a, "justifyblock", "justify");

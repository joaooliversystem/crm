...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <div class="acoes">
            <button type="button" class="btn btn-sm btn-default btn-outline-dark" onclick="adicionar('Adicionar Funcionario','funcionario');"><i
                    class="icon mr5 fa fa-plus-circle c_verde"></i> Novo Funcionario
            </button>
            ...
            <table class="table table-bordered small">
                ...
                if($count > 0):
                    ...
                    foreach ($valor as $value){
                        ?>
                        <tr class="elementsadmintr" id="adminelement<?php echo $value['id'];?>" style="cursor:pointer;" onclick="selectElement('admin',<?php echo $value['id'];?>);" ondblclick="editar('Funcionarios','funcionario',<?php echo $value['id'];?>)">
                            <td><?php echo $value['id'];?></td>
                            <td><?php echo $value['nome'];?></td>
                            <td><?php echo $value['cpf_cnpj'];?></td>
                            <td><?php echo $value['email'];?></td>
                            <td><?php echo $this->FuncoesAdmin_Model->ProjetosFuncionario($value['id']);?></td>
